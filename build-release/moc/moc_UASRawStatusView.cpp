...
static const char qt_meta_stringdata_UASRawStatusView[] = {
    "UASRawStatusView\0\0updateTableTimerTick()\0"
...
const QMetaObjectExtraData UASRawStatusView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UASRawStatusView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UASRawStatusView,
      qt_meta_data_UASRawStatusView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UASRawStatusView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UASRawStatusView))
        return static_cast<void*>(const_cast< UASRawStatusView*>(this));
