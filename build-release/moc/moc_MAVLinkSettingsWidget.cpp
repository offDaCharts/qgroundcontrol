...
static const char qt_meta_stringdata_MAVLinkSettingsWidget[] = {
    "MAVLinkSettingsWidget\0\0fileName\0"
    "updateLogfileName(QString)\0"
    "chooseLogfileName()\0enable\0"
    "enableDroneOS(bool)\0key\0setDroneOSKey(QString)\0"
    "host\0setDroneOSHost(QString)\0"
};
...
const QMetaObjectExtraData MAVLinkSettingsWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MAVLinkSettingsWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MAVLinkSettingsWidget,
      qt_meta_data_MAVLinkSettingsWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MAVLinkSettingsWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MAVLinkSettingsWidget))
