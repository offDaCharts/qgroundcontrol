...
static const char qt_meta_stringdata_QGCMapTool[] = {
    "QGCMapTool\0\0visible\0visibilityChanged(bool)\0"
    "zoom\0setZoom(int)\0"
};
...
const QMetaObjectExtraData QGCMapTool::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QGCMapTool::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCMapTool,
      qt_meta_data_QGCMapTool, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QGCMapTool::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGCMapTool))
