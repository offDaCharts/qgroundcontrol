...
static const char qt_meta_stringdata_QGCHilJSBSimConfiguration[] = {
    "QGCHilJSBSimConfiguration\0\0"
...
const QMetaObjectExtraData QGCHilJSBSimConfiguration::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QGCHilJSBSimConfiguration::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCHilJSBSimConfiguration,
      qt_meta_data_QGCHilJSBSimConfiguration, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QGCHilJSBSimConfiguration::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGCHilJSBSimConfiguration))
        return static_cast<void*>(const_cast< QGCHilJSBSimConfiguration*>(this));
