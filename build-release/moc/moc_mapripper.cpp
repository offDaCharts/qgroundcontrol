...
static const char qt_meta_stringdata_mapcontrol__MapRipper[] = {
    "mapcontrol::MapRipper\0\0perc\0"
    "percentageChanged(int)\0total,actual\0"
    "numberOfTilesChanged(int,int)\0prov,zoom\0"
    "providerChanged(QString,int)\0finish()\0"
};
...
const QMetaObjectExtraData mapcontrol::MapRipper::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mapcontrol::MapRipper::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_mapcontrol__MapRipper,
      qt_meta_data_mapcontrol__MapRipper, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &mapcontrol::MapRipper::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mapcontrol__MapRipper))
        return static_cast<void*>(const_cast< MapRipper*>(this));
