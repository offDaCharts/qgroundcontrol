...
static const char qt_meta_stringdata_QGCMainWindowAPConfigurator[] = {
    "QGCMainWindowAPConfigurator\0"
};
...
const QMetaObjectExtraData QGCMainWindowAPConfigurator::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QGCMainWindowAPConfigurator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGCMainWindowAPConfigurator,
      qt_meta_data_QGCMainWindowAPConfigurator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QGCMainWindowAPConfigurator::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGCMainWindowAPConfigurator))
