...
static const char qt_meta_stringdata_UASQuickViewItemSelect[] = {
    "UASQuickViewItemSelect\0\0value\0"
    "valueEnabled(QString)\0valueDisabled(QString)\0"
    "checked\0checkBoxClicked(bool)\0"
};
...
const QMetaObjectExtraData UASQuickViewItemSelect::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject UASQuickViewItemSelect::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UASQuickViewItemSelect,
      qt_meta_data_UASQuickViewItemSelect, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &UASQuickViewItemSelect::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UASQuickViewItemSelect))
