...
static const char qt_meta_stringdata_BasicPidConfig[] = {
    "BasicPidConfig\0"
};
...
const QMetaObjectExtraData BasicPidConfig::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject BasicPidConfig::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BasicPidConfig,
      qt_meta_data_BasicPidConfig, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BasicPidConfig::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BasicPidConfig))
        return static_cast<void*>(const_cast< BasicPidConfig*>(this));
