...
void QwtPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->selected((*reinterpret_cast< const QwtPolygon(*)>(_a[1]))); break;
        case 1: _t->appended((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 2: _t->moved((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 3: _t->changed((*reinterpret_cast< const QwtPolygon(*)>(_a[1]))); break;
        default: ;
        }
    }
}
