...
static const char qt_meta_stringdata_GeoFenceConfig[] = {
    "GeoFenceConfig\0"
};
...
const QMetaObjectExtraData GeoFenceConfig::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GeoFenceConfig::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GeoFenceConfig,
      qt_meta_data_GeoFenceConfig, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GeoFenceConfig::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GeoFenceConfig))
        return static_cast<void*>(const_cast< GeoFenceConfig*>(this));
