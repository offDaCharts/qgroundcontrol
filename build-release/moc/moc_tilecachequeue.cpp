...
static const char qt_meta_stringdata_core__TileCacheQueue[] = {
    "core::TileCacheQueue\0"
};
...
const QMetaObjectExtraData core::TileCacheQueue::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject core::TileCacheQueue::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_core__TileCacheQueue,
      qt_meta_data_core__TileCacheQueue, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &core::TileCacheQueue::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_core__TileCacheQueue))
