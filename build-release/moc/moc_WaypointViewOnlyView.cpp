...
static const char qt_meta_stringdata_WaypointViewOnlyView[] = {
    "WaypointViewOnlyView\0\0"
    "changeCurrentWaypoint(quint16)\0,\0"
    "changeAutoContinue(quint16,bool)\0state\0"
    "changedCurrent(int)\0changedAutoContinue(int)\0"
    "updateValues()\0setCurrent(bool)\0"
};
...
const QMetaObjectExtraData WaypointViewOnlyView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject WaypointViewOnlyView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WaypointViewOnlyView,
      qt_meta_data_WaypointViewOnlyView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &WaypointViewOnlyView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WaypointViewOnlyView))
        return static_cast<void*>(const_cast< WaypointViewOnlyView*>(this));
