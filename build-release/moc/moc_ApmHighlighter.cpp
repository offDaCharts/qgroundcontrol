...
static const char qt_meta_stringdata_APMHighlighter[] = {
    "APMHighlighter\0"
};
...
const QMetaObjectExtraData APMHighlighter::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject APMHighlighter::staticMetaObject = {
    { &QSyntaxHighlighter::staticMetaObject, qt_meta_stringdata_APMHighlighter,
      qt_meta_data_APMHighlighter, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &APMHighlighter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_APMHighlighter))
