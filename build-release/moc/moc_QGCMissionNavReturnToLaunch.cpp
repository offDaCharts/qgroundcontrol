...
static const char qt_meta_stringdata_QGCMissionNavReturnToLaunch[] = {
    "QGCMissionNavReturnToLaunch\0"
};
...
const QMetaObjectExtraData QGCMissionNavReturnToLaunch::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QGCMissionNavReturnToLaunch::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCMissionNavReturnToLaunch,
      qt_meta_data_QGCMissionNavReturnToLaunch, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QGCMissionNavReturnToLaunch::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGCMissionNavReturnToLaunch))
