...
static const char qt_meta_stringdata_QGCTCPLinkConfiguration[] = {
...
const QMetaObjectExtraData QGCTCPLinkConfiguration::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QGCTCPLinkConfiguration::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCTCPLinkConfiguration,
      qt_meta_data_QGCTCPLinkConfiguration, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QGCTCPLinkConfiguration::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGCTCPLinkConfiguration))
