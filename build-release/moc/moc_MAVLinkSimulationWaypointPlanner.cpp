...
static const char qt_meta_stringdata_MAVLinkSimulationWaypointPlanner[] = {
    "MAVLinkSimulationWaypointPlanner\0\0msg\0"
    "messageSent(mavlink_message_t)\0"
...
const QMetaObjectExtraData MAVLinkSimulationWaypointPlanner::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MAVLinkSimulationWaypointPlanner::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MAVLinkSimulationWaypointPlanner,
      qt_meta_data_MAVLinkSimulationWaypointPlanner, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MAVLinkSimulationWaypointPlanner::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MAVLinkSimulationWaypointPlanner))
