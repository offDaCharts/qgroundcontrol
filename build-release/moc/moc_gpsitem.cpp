...
static const char qt_meta_stringdata_mapcontrol__GPSItem[] = {
    "mapcontrol::GPSItem\0\0waypointnumber,waypoint\0"
...
const QMetaObjectExtraData mapcontrol::GPSItem::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mapcontrol::GPSItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mapcontrol__GPSItem,
      qt_meta_data_mapcontrol__GPSItem, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &mapcontrol::GPSItem::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mapcontrol__GPSItem))
