...
static const char qt_meta_stringdata_QGCUDPLinkConfiguration[] = {
    "QGCUDPLinkConfiguration\0\0addHost()\0"
};
...
const QMetaObjectExtraData QGCUDPLinkConfiguration::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QGCUDPLinkConfiguration::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGCUDPLinkConfiguration,
      qt_meta_data_QGCUDPLinkConfiguration, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QGCUDPLinkConfiguration::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGCUDPLinkConfiguration))
