...
static const char qt_meta_stringdata_ApmPlaneLevel[] = {
    "ApmPlaneLevel\0\0uas,component,parameterName,value\0"
    "parameterChanged(int,int,QString,QVariant)\0"
    "levelClicked()\0checked\0"
    "manualCheckBoxToggled(bool)\0"
};
...
const QMetaObjectExtraData ApmPlaneLevel::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ApmPlaneLevel::staticMetaObject = {
    { &AP2ConfigWidget::staticMetaObject, qt_meta_stringdata_ApmPlaneLevel,
      qt_meta_data_ApmPlaneLevel, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ApmPlaneLevel::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ApmPlaneLevel))
        return static_cast<void*>(const_cast< ApmPlaneLevel*>(this));
