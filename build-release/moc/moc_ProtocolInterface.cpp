...
static const char qt_meta_stringdata_ProtocolInterface[] = {
    "ProtocolInterface\0\0uasId,loss\0"
    "receiveLossChanged(int,float)\0link,b\0"
...
const QMetaObjectExtraData ProtocolInterface::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ProtocolInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ProtocolInterface,
      qt_meta_data_ProtocolInterface, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ProtocolInterface::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ProtocolInterface))
        return static_cast<void*>(const_cast< ProtocolInterface*>(this));
