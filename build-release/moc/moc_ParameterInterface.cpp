...
static const char qt_meta_stringdata_ParameterInterface[] = {
    "ParameterInterface\0\0uas\0addUAS(UASInterface*)\0"
    "index\0selectUAS(int)\0"
};
...
const QMetaObjectExtraData ParameterInterface::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ParameterInterface::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ParameterInterface,
      qt_meta_data_ParameterInterface, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ParameterInterface::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ParameterInterface))
        return static_cast<void*>(const_cast< ParameterInterface*>(this));
