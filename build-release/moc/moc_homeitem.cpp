...
static const char qt_meta_stringdata_mapcontrol__HomeItem[] = {
    "mapcontrol::HomeItem\0"
};
...
const QMetaObjectExtraData mapcontrol::HomeItem::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject mapcontrol::HomeItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_mapcontrol__HomeItem,
      qt_meta_data_mapcontrol__HomeItem, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &mapcontrol::HomeItem::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_mapcontrol__HomeItem))
