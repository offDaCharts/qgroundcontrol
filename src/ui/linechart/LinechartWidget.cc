...
void LinechartWidget::startLogging()
{
    ...
    while (!(fileName.endsWith(".log")) && !abort && fileName != "") {
        ...
        fileName = QFileDialog::getSaveFileName(this, tr("Bad file name, Specify new log file name"), QDesktopServices::storageLocation(QDesktopServices::DesktopLocation), tr("Logfile (*.log);;"));
    }
